...
<div class="service-tier-wrapper">
    <div class="grid-3">
        ...
        <div class="info-card service-tier">
    <h3>Membership</h3>
    <p>Priority support & annual<span class="mobile-break"></span>maintenance walkthroughs.</p>
    <h2>$199/yr</h2>
...
<div style="text-align: center; max-width: 900px; margin: 40px auto; padding: 35px; border: 1px solid rgba(255, 102, 0, 0.4); border-radius: 12px; background: linear-gradient(145deg, rgba(255,102,0,0.05), rgba(0,0,0,0.2)); box-shadow: 0 0 25px rgba(255, 102, 0, 0.05);">
    <h3 style="color: var(--flame); margin-top: 0; letter-spacing: 1px;">STEP 1: PRE-FLIGHT CHECKLIST</h3>
    <p style="color: #ccc; margin-bottom: 25px; text-align: center;">To prevent service delays, you must review the <strong>Clinic Protocols</strong> before the booking form is unlocked.</p>
    
    <a href="faq.php" class="book-btn" style="display: inline-flex; align-items: center; gap: 15px;">
        ...
        <div style="text-align: left;">
            <span style="font-size: 1.2rem; display: block; line-height: 1.1;">REVIEW PROTOCOLS</span>
            <span style="font-size: 0.75rem; font-weight: normal; opacity: 0.8; text-transform: uppercase;">& Unlock Booking Form</span>
        </div>
    </a>
    
    <div style="margin-top: 20px; font-size: 0.85rem; color: #e0e0e0; font-style: italic;">
        Read time: ~90 seconds. Straight to the point—no runaround.
    </div>
</div>
