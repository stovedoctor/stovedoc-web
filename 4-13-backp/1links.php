...
<?php include 'nav.php'; ?>
 ...
 <div class="section-wrapper" style="max-width: 1000px; margin: 40px auto 10px auto; text-align: left;">
    ...
    <div class="affiliate-img">
        <img 
    src="flipstick_300.webp?v=<?php echo $v; ?>" 
    srcset="flipstick_300.webp?v=<?php echo $v; ?> 400w, flipstick_300.webp?v=<?php echo $v; ?> 600w" 
...
<div class="doc-order" style="padding: 10px; margin: 0 0 15px 0; font-size: 0.9rem;">
 ...
 <!-- drop down -->
  ...
  <div class="affiliate-card look-solid">
    <div class="affiliate-img">
        <img src="mini_ratchet_full.webp" 
             srcset="mini_ratchet_mb.webp 400w, mini_ratchet_full.webp 600w" 
 ...
 <div class="section-wrapper" style="max-width: 1000px; margin: 40px auto 10px auto; text-align: left;">
    ...
    <div class="affiliate-card look-solid">
        <div class="affiliate-img">
            <img src="astro_full.webp" 
                 srcset="astro_mb.webp 400w, astro_full.webp 600w" 
                 sizes="(max-width: 768px) 400px, 600px" 
                 alt="AstroAI 2000" 
                 onclick="openDiagnostic(this.src)"
                 loading="lazy">
        ...
        <div class="affiliate-content">
            <span class="doc-stamp" style="border: 1px solid #888; color: #888; text-transform: uppercase; font-weight: 800; padding: 2px 8px; font-size: 0.75rem; border-radius: 4px; letter-spacing: 1px;">
                Budget Essential
            </span>
    ...
    <div class="affiliate-card look-solid">
        <div class="affiliate-img">
            <img src="cl800_full.webp" 
                 srcset="cl800_mb.webp 400w, cl800_full.webp 600w" 
                 sizes="(max-width: 768px) 400px, 600px" 
                 alt="Klein CL800" 
                 onclick="openDiagnostic(this.src)"
                 loading="lazy">
